...
render.onTriggered = function ()
{
    ...
    velAreaSys.bgShader.pushTexture(texposuni, cglframeStoreparticleSys.texPos);
    velAreaSys.bgShader.pushTexture(texMuluni, inTexMultiply.get());
    velAreaSys.bgShader.pushTexture(texAbsVel, cglframeStoreparticleSys.texAbsVel);
    velAreaSys.bgShader.pushTexture(texLifeProgress, cglframeStoreparticleSys.texLifeProgress);
    velAreaSys.bgShader.pushTexture(texTiming, cglframeStoreparticleSys.texTimingInt);
