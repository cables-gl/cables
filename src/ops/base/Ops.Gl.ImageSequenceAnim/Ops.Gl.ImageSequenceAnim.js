...
var inOffsetY=op.addInPort(new Port(op,"Row Offset Y",CABLES.OP_PORT_TYPE_VALUE));
var numFrames=op.addInPort(new Port(op,"Num Frames",CABLES.OP_PORT_TYPE_VALUE));
