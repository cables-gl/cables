const
    ...
    flip = op.addInPort(new CABLES.Port(op, "flip", CABLES.Port.TYPE_VALUE, { "display": "bool" })),
    unpackAlpha = op.addInPort(new CABLES.Port(op, "unpackPreMultipliedAlpha", CABLES.Port.TYPE_VALUE, { "display": "bool" })),
