...
var ratio=op.addInPort(new CABLES.Port(op,"ratio",CABLES.OP_PORT_TYPE_VALUE ,{display:'dropdown',values:[0.5,0.5625,0.75,1,1.25,1.3333333333,1.777777777778,2.33333333333333,3,4]} ));
