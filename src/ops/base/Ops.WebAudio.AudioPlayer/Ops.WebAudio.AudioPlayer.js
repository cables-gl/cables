...
var play=op.addInPort(new Port(this,"play",CABLES.OP_PORT_TYPE_VALUE,{ display:'bool' }));
var autoPlay=op.addInPort(new Port(this,"Autoplay",CABLES.OP_PORT_TYPE_VALUE,{ display:'bool' }));

var volume=this.addInPort(new Port(this,"volume",CABLES.OP_PORT_TYPE_VALUE,{ display:'range' }));
var synchronizedPlayer=this.addInPort(new Port(this,"Synchronized Player",CABLES.OP_PORT_TYPE_VALUE,{ display:'bool' }));

this.audioOut=this.addOutPort(new Port(this, "audio out",CABLES.OP_PORT_TYPE_OBJECT));
var outPlaying=this.addOutPort(new Port(this, "playing",CABLES.OP_PORT_TYPE_VALUE));
var outEnded=this.addOutPort(new Port(this, "ended",CABLES.OP_PORT_TYPE_FUNCTION));


var doLoop=op.addInPort(new Port(this,"Loop",CABLES.OP_PORT_TYPE_VALUE,{ display:'bool' }));
