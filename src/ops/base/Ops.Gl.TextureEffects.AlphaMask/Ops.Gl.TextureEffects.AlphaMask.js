...
// this.amount=this.addInPort(new Port(this,"amount",CABLES.OP_PORT_TYPE_VALUE,{ display:'range' }));
...
this.method=this.addInPort(new Port(this,"method",CABLES.OP_PORT_TYPE_VALUE ,{display:'dropdown',values:["luminance","image alpha","red","green","blue"]} ));
