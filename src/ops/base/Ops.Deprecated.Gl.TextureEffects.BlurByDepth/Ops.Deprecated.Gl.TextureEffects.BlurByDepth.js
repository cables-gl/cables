...
var depthTex=this.addInPort(new Port(this,"depth texture",CABLES.OP_PORT_TYPE_TEXTURE));
...
var depthStart=this.addInPort(new Port(this,"depth start",CABLES.OP_PORT_TYPE_VALUE,{"display":"range"}));
var depthEnd=this.addInPort(new Port(this,"depth end",CABLES.OP_PORT_TYPE_VALUE,{"display":"range"}));
...
var direction=this.addInPort(new Port(this,"direction",CABLES.OP_PORT_TYPE_VALUE,{display:'dropdown',values:['both','vertical','horizontal']}));
var dir=0;
direction.set('both');
