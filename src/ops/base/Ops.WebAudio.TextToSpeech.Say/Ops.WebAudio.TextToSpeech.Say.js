...
var voicePort = op.addInPort( new Port( op, "Voice", CABLES.OP_PORT_TYPE_, { display: 'dropdown', values: voiceMapKeys } ) );
var pitchPort = op.addInPort( new Port( op, "Pitch", CABLES.OP_PORT_TYPE_, { 'display': 'range', 'min': PITCH_MIN, 'max': PITCH_MAX } ));
pitchPort.set(PITCH_DEFAULT);
var ratePort = op.addInPort( new Port( op, "Rate", CABLES.OP_PORT_TYPE_, { 'display': 'range', 'min': RATE_MIN, 'max': RATE_MAX } ));
