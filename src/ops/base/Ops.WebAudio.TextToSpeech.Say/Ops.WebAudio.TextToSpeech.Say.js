...
var voicePort = op.addInPort( new Port( op, "Voice", OP_PORT_TYPE_VALUE, { display: 'dropdown', values: voiceMapKeys } ) );
var pitchPort = op.addInPort( new Port( op, "Pitch", OP_PORT_TYPE_VALUE, { 'display': 'range', 'min': PITCH_MIN, 'max': PITCH_MAX } ));
pitchPort.set(PITCH_DEFAULT);
var ratePort = op.addInPort( new Port( op, "Rate", OP_PORT_TYPE_VALUE, { 'display': 'range', 'min': RATE_MIN, 'max': RATE_MAX } ));
