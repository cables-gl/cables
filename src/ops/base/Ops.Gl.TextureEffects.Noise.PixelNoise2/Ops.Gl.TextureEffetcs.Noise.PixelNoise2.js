...
const minValue=op.inValue("Minimum value",0);
const maxValue=op.inValue("Maximum value",1);
...
minValue.uniform==new CGL.Uniform(shader,'f','minIn',minValue);
maxValue.uniform==new CGL.Uniform(shader,'f','maxIn',maxValue);
