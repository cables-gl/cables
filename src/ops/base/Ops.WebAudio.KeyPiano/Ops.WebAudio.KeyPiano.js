let c_on = this.addInPort(new CABLES.Port(this, "c note on", CABLES.Port.TYPE_FUNCTION));
let c_off = this.addInPort(new CABLES.Port(this, "c note off", CABLES.Port.TYPE_FUNCTION));
let cis_on = this.addInPort(new CABLES.Port(this, "cis note on", CABLES.Port.TYPE_FUNCTION));
let cis_off = this.addInPort(new CABLES.Port(this, "cis note off", CABLES.Port.TYPE_FUNCTION));
let d_on = this.addInPort(new CABLES.Port(this, "d note on", CABLES.Port.TYPE_FUNCTION));
let d_off = this.addInPort(new CABLES.Port(this, "d note off", CABLES.Port.TYPE_FUNCTION));
let dis_on = this.addInPort(new CABLES.Port(this, "dis note on", CABLES.Port.TYPE_FUNCTION));
let dis_off = this.addInPort(new CABLES.Port(this, "dis note off", CABLES.Port.TYPE_FUNCTION));
let e_on = this.addInPort(new CABLES.Port(this, "e note on", CABLES.Port.TYPE_FUNCTION));
let e_off = this.addInPort(new CABLES.Port(this, "e note off", CABLES.Port.TYPE_FUNCTION));
let f_on = this.addInPort(new CABLES.Port(this, "f note on", CABLES.Port.TYPE_FUNCTION));
let f_off = this.addInPort(new CABLES.Port(this, "f note off", CABLES.Port.TYPE_FUNCTION));
let fis_on = this.addInPort(new CABLES.Port(this, "fis note on", CABLES.Port.TYPE_FUNCTION));
let fis_off = this.addInPort(new CABLES.Port(this, "fis note off", CABLES.Port.TYPE_FUNCTION));
let g_on = this.addInPort(new CABLES.Port(this, "g note on", CABLES.Port.TYPE_FUNCTION));
let g_off = this.addInPort(new CABLES.Port(this, "g note off", CABLES.Port.TYPE_FUNCTION));
let gis_on = this.addInPort(new CABLES.Port(this, "gis note ons", CABLES.Port.TYPE_FUNCTION));
let gis_off = this.addInPort(new CABLES.Port(this, "gis note off", CABLES.Port.TYPE_FUNCTION));
let a_on = this.addInPort(new CABLES.Port(this, "a note on", CABLES.Port.TYPE_FUNCTION));
let a_off = this.addInPort(new CABLES.Port(this, "a note off", CABLES.Port.TYPE_FUNCTION));
let ais_on = this.addInPort(new CABLES.Port(this, "ais note on", CABLES.Port.TYPE_FUNCTION));
let ais_off = this.addInPort(new CABLES.Port(this, "ais note off", CABLES.Port.TYPE_FUNCTION));
let b_on = this.addInPort(new CABLES.Port(this, "b note on", CABLES.Port.TYPE_FUNCTION));
let b_off = this.addInPort(new CABLES.Port(this, "b note off", CABLES.Port.TYPE_FUNCTION));

let frequency = this.addOutPort(new CABLES.Port(this, "frequency", CABLES.Port.TYPE_VALUE));
let isPressed = this.addOutPort(new CABLES.Port(this, "is pressed", CABLES.Port.TYPE_VALUE));
...
let octave = this.addInPort(new CABLES.Port(this, "octave", CABLES.Port.TYPE_));
