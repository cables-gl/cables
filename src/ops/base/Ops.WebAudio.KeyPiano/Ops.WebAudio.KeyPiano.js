...
var cis_on = this.addInPort( new CABLES.Port( this, "cis note on",CABLES.OP_PORT_TYPE_FUNCTION ));
var cis_off = this.addInPort( new CABLES.Port( this, "cis note off",CABLES.OP_PORT_TYPE_FUNCTION ));
var d_on = this.addInPort( new CABLES.Port( this, "d note on",CABLES.OP_PORT_TYPE_FUNCTION ));
var d_off = this.addInPort( new CABLES.Port( this, "d note off",CABLES.OP_PORT_TYPE_FUNCTION ));
var dis_on = this.addInPort( new CABLES.Port( this, "dis note on",CABLES.OP_PORT_TYPE_FUNCTION ));
var dis_off = this.addInPort( new CABLES.Port( this, "dis note off",CABLES.OP_PORT_TYPE_FUNCTION ));
var e_on = this.addInPort( new CABLES.Port( this, "e note on",CABLES.OP_PORT_TYPE_FUNCTION ));
var e_off = this.addInPort( new CABLES.Port( this, "e note off",CABLES.OP_PORT_TYPE_FUNCTION ));
var f_on = this.addInPort( new CABLES.Port( this, "f note on",CABLES.OP_PORT_TYPE_FUNCTION ));
var f_off = this.addInPort( new CABLES.Port( this, "f note off",CABLES.OP_PORT_TYPE_FUNCTION ));
var fis_on = this.addInPort( new CABLES.Port( this, "fis note on",CABLES.OP_PORT_TYPE_FUNCTION ));
var fis_off = this.addInPort( new CABLES.Port( this, "fis note off",CABLES.OP_PORT_TYPE_FUNCTION ));
var g_on = this.addInPort( new CABLES.Port( this, "g note on",CABLES.OP_PORT_TYPE_FUNCTION ));
var g_off = this.addInPort( new CABLES.Port( this, "g note off",CABLES.OP_PORT_TYPE_FUNCTION ));
var gis_on = this.addInPort( new CABLES.Port( this, "gis note ons",CABLES.OP_PORT_TYPE_FUNCTION ));
var gis_off = this.addInPort( new CABLES.Port( this, "gis note off",CABLES.OP_PORT_TYPE_FUNCTION ));
var a_on = this.addInPort( new CABLES.Port( this, "a note on",CABLES.OP_PORT_TYPE_FUNCTION ));
var a_off = this.addInPort( new CABLES.Port( this, "a note off",CABLES.OP_PORT_TYPE_FUNCTION ));
var ais_on = this.addInPort( new CABLES.Port( this, "ais note on",CABLES.OP_PORT_TYPE_FUNCTION ));
var ais_off = this.addInPort( new CABLES.Port( this, "ais note off",CABLES.OP_PORT_TYPE_FUNCTION ));
var b_on = this.addInPort( new CABLES.Port( this, "b note on",CABLES.OP_PORT_TYPE_FUNCTION ));
var b_off = this.addInPort( new CABLES.Port( this, "b note off",CABLES.OP_PORT_TYPE_FUNCTION ));
