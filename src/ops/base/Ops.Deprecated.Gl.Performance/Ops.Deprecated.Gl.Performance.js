...
var textureOut=this.addOutPort(new Port(this,"texture",CABLES.OP_PORT_TYPE_TEXTURE));
var outFPS=this.addOutPort(new Port(this,"fps",CABLES.OP_PORT_TYPE_VALUE));
