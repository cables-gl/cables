...
function checkTypes()
{
    if (inTex.isLinked() && inTex.get() && tex.textureType != inTex.get().textureType && (inTex.get().textureType != CGL.Texture.TYPE_FLOAT || inTex.get().textureType == CGL.Texture.TYPE_FLOAT))
