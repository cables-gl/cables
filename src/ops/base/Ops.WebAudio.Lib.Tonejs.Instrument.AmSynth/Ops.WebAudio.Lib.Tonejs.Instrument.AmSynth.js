...
var modulationOscillatorPort = op.addInPort( new Port( op, "Modulation Oscillator Type", CABLES.OP_PORT_TYPE_, { display: 'dropdown', values: OSCILLATOR_TYPES } ) );
