...

{
    ...
    // texture flip
    //
    var flipX=op.inBool("flip x");
    var flipY=op.inBool("flip y");
...

{
    ...
    var inClipRepeat=op.inBool("Clip Repeat",false);
