...
this.min=this.addInPort(new Port(this,"min",CABLES.OP_PORT_TYPE_VALUE,{display:'range'}));
this.max=this.addInPort(new Port(this,"max",CABLES.OP_PORT_TYPE_VALUE,{display:'range'}));
