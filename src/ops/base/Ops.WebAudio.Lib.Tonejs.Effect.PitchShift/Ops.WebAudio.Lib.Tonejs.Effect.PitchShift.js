...
var windowSizePort = op.addInPort( new Port( op, "Window Size", CABLES.OP_PORT_TYPE_, { 'display': 'range', 'min': WINDOW_SIZE_MIN, 'max': WINDOW_SIZE_MAX }, node.get("windowSize").windowSize ));
