...
const shaderOut=op.addOutPort(new Port(op,"shader",CABLES.OP_PORT_TYPE_OBJECT));
...
{
    // opacity texture 
    op.textureOpacity=op.addInPort(new Port(op,"textureOpacity",CABLES.OP_PORT_TYPE_TEXTURE,{preview:true,display:'createOpHelper'}));
...
op.colorizeTexture=op.addInPort(new Port(op,"colorizeTexture",CABLES.OP_PORT_TYPE_VALUE,{ display:'bool' }));
...
op.doBillboard=op.addInPort(new Port(op,"billboard",CABLES.OP_PORT_TYPE_VALUE,{ display:'bool' }));
...

{
    ...
    var diffuseRepeatX=op.addInPort(new Port(op,"diffuseRepeatX",CABLES.OP_PORT_TYPE_VALUE));
    var diffuseRepeatY=op.addInPort(new Port(op,"diffuseRepeatY",CABLES.OP_PORT_TYPE_VALUE));
    var diffuseOffsetX=op.addInPort(new Port(op,"Tex Offset X",CABLES.OP_PORT_TYPE_VALUE));
    var diffuseOffsetY=op.addInPort(new Port(op,"Tex Offset Y",CABLES.OP_PORT_TYPE_VALUE));
