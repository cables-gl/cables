...
function updateGradient(keys)
{
    ...
    if (texAlpha)texAlpha = texAlpha.dispose();
    tex = new CGL.Texture(cgl, { "name": "gradienttex" });
    texAlpha = new CGL.Texture(cgl, { "name": "gradienttexAlpha" });
