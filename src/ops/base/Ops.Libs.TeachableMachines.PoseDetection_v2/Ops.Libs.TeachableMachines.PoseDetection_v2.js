...
const videoElement = op.inObject("Webcam Element");
...
const flipImageOut = op.outBoolNum("Image flipped");
...
async function loop()
{
    ...
    if (videoElement.get())
    {
        ...
        camCtx.drawImage(videoElement.get(), 0, 0, camCanvas.width, camCanvas.height);
        await predict();
    }
    outTrigger.trigger();
}
