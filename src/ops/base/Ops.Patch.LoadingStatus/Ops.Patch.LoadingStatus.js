...
this.finished=this.addOutPort(new Port(this,"finished",CABLES.OP_PORT_TYPE_FUNCTION));
var result=this.addOutPort(new Port(this,"status",CABLES.OP_PORT_TYPE_VALUE));
var isFinishedPort = op.outValue('all loaded', false);
var preRenderStatus=this.addOutPort(new Port(this,"preRenderStatus",CABLES.OP_PORT_TYPE_VALUE));
var preRenderTimeFrames=this.addInPort(new Port(this,"preRenderTimes",CABLES.OP_PORT_TYPE_VALUE));
var preRenderOps=op.inValueBool("PreRender Ops");
preRenderStatus.set(0);
this.numAssets=this.addOutPort(new Port(this,"numAssets",CABLES.OP_PORT_TYPE_VALUE));
this.loading=this.addOutPort(new Port(this,"loading",CABLES.OP_PORT_TYPE_FUNCTION));
var loadingFinished=op.outFunction("loading finished");//this.addOutPort(new Port(this,"loading finished",CABLES.OP_PORT_TYPE_FUNCTION));
