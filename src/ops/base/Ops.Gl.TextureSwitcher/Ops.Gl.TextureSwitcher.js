...
var num=this.addInPort(new Port(this,"num",CABLES.OP_PORT_TYPE_VALUE));
var defaultTransparent=op.inValueBool("Default Texture Transparent",true);
var textureOut=this.addOutPort(new Port(this,"texture",CABLES.OP_PORT_TYPE_TEXTURE,{preview:true}));
...
for(var i=0;i<16;i++)
{
    var tex=this.addInPort(new Port(this,"texture"+i,CABLES.OP_PORT_TYPE_TEXTURE));
