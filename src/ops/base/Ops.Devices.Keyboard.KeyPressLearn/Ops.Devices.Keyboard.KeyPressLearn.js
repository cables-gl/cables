...
var onPress=op.addOutPort(new Port(op,"on press",CABLES.OP_PORT_TYPE_FUNCTION));
var onRelease=op.addOutPort(new Port(op,"on release",CABLES.OP_PORT_TYPE_FUNCTION));
...
var modKey=op.addInPort(new Port(op,"Mod Key",CABLES.OP_PORT_TYPE_VALUE ,{display:'dropdown',values:['none','alt']} ));
