...
const render = function() {
    ...
    var shaderToRender = shader;

    if (!cgl.shadowPass) {
    cgl.setShader(shaderToRender);
    shader.bindTextures();
    outTrigger.trigger();
    cgl.setPreviousShader();
        ...
        // shaderToRender = cgl.getDefaultShader();
        // cgl.setShader(shaderToRender);
        outTrigger.trigger();
        //cgl.setPreviousShader();
        //cgl.setShader(cgl.getDefaultShader);
        //op.log("4 shader after pop", cgl._shaderStack.map(shader => shader._name));
        //  cgl.setPreviousShader();
    }
}
