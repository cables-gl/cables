...
op.texture=op.addInPort(new Port(op,"texture",CABLES.OP_PORT_TYPE_TEXTURE,{preview:true,display:'createOpHelper'}));
...
var w=op.addInPort(new Port(op,"weightMul",CABLES.OP_PORT_TYPE_VALUE,{ display:'range'}));
w.set(0.6);
...
var white=op.addInPort(new Port(op,"white",CABLES.OP_PORT_TYPE_VALUE,{ display:'range' }));
white.set(0.0);
