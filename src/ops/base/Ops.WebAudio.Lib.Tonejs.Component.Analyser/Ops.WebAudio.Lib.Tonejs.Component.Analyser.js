...
//var sizePort = op.addInPort( new Port( this, "Size", CABLES.OP_PORT_TYPE_, { 'display': 'range', 'min': SIZE_MIN, 'max': SIZE_MAX }, SIZE_DEFAULT ));
var sizePort = this.addInPort( new Port( this, "Size", CABLES.OP_PORT_TYPE_, { display: 'dropdown', values: SIZES } ) );
sizePort.set(SIZE_DEFAULT);
var typePort = this.addInPort( new Port( this, "Type", CABLES.OP_PORT_TYPE_, { display: 'dropdown', values: TYPES } ) );
typePort.set(TYPE_DEFAULT);
var smoothingPort = op.addInPort( new Port( this, "Smoothing", CABLES.OP_PORT_TYPE_, { 'display': 'range', 'min': SMOOTHING_MIN, 'max': SMOOTHING_MAX }, SMOOTHING_DEFAULT ));
smoothingPort.set(SMOOTHING_DEFAULT);
var maxDecibelsPort = op.addInPort( new Port( this, "Max Decibels", CABLES.OP_PORT_TYPE_, { 'display': 'range', 'min': DECIBELS_RANGE_MIN, 'max': DECIBELS_RANGE_MAX }, MAX_DECIBELS_DEFAULT ));
maxDecibelsPort.set(MAX_DECIBELS_DEFAULT);
var minDecibelsPort = op.addInPort( new Port( this, "Min Decibels", CABLES.OP_PORT_TYPE_, { 'display': 'range', 'min': DECIBELS_RANGE_MIN, 'max': DECIBELS_RANGE_MAX }, MIN_DECIBELS_DEFAULT ));
minDecibelsPort.set(MIN_DECIBELS_DEFAULT);
var returnTypePort = this.addInPort( new Port( this, "Return Type", CABLES.OP_PORT_TYPE_, { display: 'dropdown', values: RETURN_TYPES } ) );
