...
var maximize=op.addInPort(new Port(op,"Maximize Size",CABLES.OP_PORT_TYPE_VALUE,{display:'bool'}));
...
var valign=op.addInPort(new Port(op,"vertical align",CABLES.OP_PORT_TYPE_VALUE,{display:'dropdown',values:['top','center','bottom']}));
var font=op.addInPort(new Port(op,"font",CABLES.OP_PORT_TYPE_VALUE,{type:'string'}));
...
// var textureOut=op.addOutPort(new Port(op,"texture",CABLES.OP_PORT_TYPE_TEXTURE));
var textureOut=op.outTexture("texture");
var outRatio=op.addOutPort(new Port(op,"Ratio",CABLES.OP_PORT_TYPE_VALUE));
...
{
    var id='canv'+texWidth.get()+'_'+texHeight.get();
