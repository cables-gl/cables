...
var smoothness=op.addInPort(new Port(op,"smoothness",CABLES.OP_PORT_TYPE_VALUE,{  }));
var scale=op.addInPort(new Port(op,"scale",CABLES.OP_PORT_TYPE_VALUE,{  }));
...
var time=op.addInPort(new Port(op,"time",CABLES.OP_PORT_TYPE_VALUE,{  }));
