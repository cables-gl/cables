...
var triggerGamePad=op.addOutPort(new Port(op,"Controller Matrix",CABLES.OP_PORT_TYPE_FUNCTION));
var numGamepads=op.addOutPort(new Port(op,"Num Controller",CABLES.OP_PORT_TYPE_VALUE));
...
var triggerAfter=op.addOutPort(new Port(op,"trigger After",CABLES.OP_PORT_TYPE_FUNCTION));
