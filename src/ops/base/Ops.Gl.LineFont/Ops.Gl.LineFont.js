...
var characters=
    [
        ...
        },
        {
            ...
            l:
            [
                [180.5,360.557,180.5,326.89,167.591,326.89,160.167,334.315],
            ]
        },
        {
            // 8
            l:
            [
                [160.167,342.932,180.5,342.932],
                [167.591,326.89,160.167,334.315,160.167,353.132,167.591,360.557,173.076,360.557,180.5,353.132,180.5,334.315,173.076,326.89,167.591,326.89],
            ]
        },
        {
            // 9
        ...
        
        {
            ...
            l:
            [
                [182.496,351.137,173.076,360.557,167.591,360.557,160.004,352.97,174.712,338.262,167.587,331.137,161.792,336.932,184.292,359.432],
            ]
        },
        {
            // '
        ...
        },
        {
            ...
            l:
            [
        		[167.591,364.224,173.076,364.224],
        		[160.167,334.315,167.591,326.89,173.076,326.89,180.5,334.315,180.5,342.932,160.167,342.932,160.167,353.132,167.591,360.557,173.076,360.557]
            ]
        },
        {
            // !
...
render.onTriggered=function()
{
    ...
    {
        var w=0;
        var charIndex=string.get().charCodeAt(i);
