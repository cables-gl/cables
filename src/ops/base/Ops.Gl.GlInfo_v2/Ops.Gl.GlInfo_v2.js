...
const
    ...
    outGlVersion = op.outString("WebGl Version", gl.getParameter(gl.VERSION)),
    outGlslVersion = op.outString("GLSL Version", gl.getParameter(gl.SHADING_LANGUAGE_VERSION)),
