...
var ratio=op.addInPort(new Port(op,"ratio",CABLES.OP_PORT_TYPE_VALUE ,{display:'dropdown',values:[1,1.25,1.3333333333,1.777777777778,1.88,2.33333333333333,2.4151,3,4]} ));
ratio.set(1.777777777778);

var blackBars=op.addInPort(new Port(op,"black bars",CABLES.OP_PORT_TYPE_VALUE,{display:'bool'}));
blackBars.set(true);
