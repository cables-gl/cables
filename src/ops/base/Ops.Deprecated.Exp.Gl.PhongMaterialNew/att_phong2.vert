...
void main()
{
    ...
    vec3 T = normalize(vec3(modelMatrix * vec4(attrTangent,   1.0)));
    vec3 B = normalize(vec3(modelMatrix * vec4(attrBiTangent, 1.0)));
    vec3 N = normalize(vec3(modelMatrix * vec4(vNormal,    1.0)));
