...

{
    ...
    // texture flip
    //
    let flipX = op.inBool("flip x");
    let flipY = op.inBool("flip y");
...

{
    ...
    let inClipRepeat = op.inBool("Clip Repeat", false);
