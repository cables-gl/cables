...
// input ports
var playPort = op.addInPort( new Port( this, "Play", CABLES.OP_PORT_TYPE_, { display: 'bool' } ) );
...
var loopPort = op.addInPort( new Port( this, "Loop", CABLES.OP_PORT_TYPE_, { display: 'bool' } ) );
