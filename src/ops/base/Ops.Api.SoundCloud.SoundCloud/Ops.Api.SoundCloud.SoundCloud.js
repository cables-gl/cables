...
var soundCloudUrl=op.addInPort(new Port(op,"SoundCloud URL",CABLES.OP_PORT_TYPE_VALUE,{type:"string"}));

var streamUrl=op.addOutPort(new Port(op,"Stream URL",CABLES.OP_PORT_TYPE_VALUE));
var artworkUrl=op.addOutPort(new Port(op,"Artwork URL",CABLES.OP_PORT_TYPE_VALUE));
var title=op.addOutPort(new Port(op,"Title",CABLES.OP_PORT_TYPE_VALUE));
