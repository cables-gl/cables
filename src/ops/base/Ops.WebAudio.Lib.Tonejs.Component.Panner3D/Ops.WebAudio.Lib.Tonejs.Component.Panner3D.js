...
var panningModelPort = op.addInPort( new CABLES.Port( op, "Panning Model", CABLES.OP_PORT_TYPE_VALUE, { display: 'dropdown', values: PANNING_MODEL_VALUES } ) );
...
var distanceModelPort = op.addInPort( new CABLES.Port( op, "Distance Model", CABLES.OP_PORT_TYPE_VALUE, { display: 'dropdown', values: DISTANCE_MODEL_VALUES } ) );
distanceModelPort.set(DISTANCE_MODEL_DEFAULT);
var coneInnerAnglePort = op.addInPort( new CABLES.Port( op, "Cone Inner Angle", CABLES.OP_PORT_TYPE_VALUE, { 'display': 'range', 'min': ANGLE_MIN, 'max': ANGLE_MAX } ));
coneInnerAnglePort.set(CONE_INNER_ANGLE_DEFAULT);
var coneOuterAnglePort = op.addInPort( new CABLES.Port( op, "Cone Outer Angle", CABLES.OP_PORT_TYPE_VALUE, { 'display': 'range', 'min': ANGLE_MIN, 'max': ANGLE_MAX } ));
