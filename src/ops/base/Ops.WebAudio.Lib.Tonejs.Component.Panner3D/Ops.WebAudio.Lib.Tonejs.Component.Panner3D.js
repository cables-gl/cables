...
var panningModelPort = op.addInPort( new Port( op, "Panning Model", CABLES.OP_PORT_TYPE_, { display: 'dropdown', values: PANNING_MODEL_VALUES } ) );
...
var distanceModelPort = op.addInPort( new Port( op, "Distance Model", CABLES.OP_PORT_TYPE_, { display: 'dropdown', values: DISTANCE_MODEL_VALUES } ) );
distanceModelPort.set(DISTANCE_MODEL_DEFAULT);
var coneInnerAnglePort = op.addInPort( new Port( op, "Cone Inner Angle", CABLES.OP_PORT_TYPE_, { 'display': 'range', 'min': ANGLE_MIN, 'max': ANGLE_MAX } ));
coneInnerAnglePort.set(CONE_INNER_ANGLE_DEFAULT);
var coneOuterAnglePort = op.addInPort( new Port( op, "Cone Outer Angle", CABLES.OP_PORT_TYPE_, { 'display': 'range', 'min': ANGLE_MIN, 'max': ANGLE_MAX } ));
