...
//inputs
var type=this.addInPort(new CABLES.Port(this,"type",CABLES.OP_PORT_TYPE_VALUE,{display:'dropdown',values:[ 'sine','square','sawtooth','triangle' ]}));
var frequency=this.addInPort(new CABLES.Port(this,"frequency",CABLES.OP_PORT_TYPE_VALUE));
