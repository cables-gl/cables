...
var image=this.addInPort(new Port(this,"image",CABLES.OP_PORT_TYPE_TEXTURE));
var farPlane=this.addInPort(new Port(this,"farplane",CABLES.OP_PORT_TYPE_VALUE));
var nearPlane=this.addInPort(new Port(this,"nearplane",CABLES.OP_PORT_TYPE_VALUE));
