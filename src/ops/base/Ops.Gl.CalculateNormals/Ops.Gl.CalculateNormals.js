...
var smoothNormals=op.addInPort(new Port(op,"Smooth",CABLES.OP_PORT_TYPE_VALUE,{"display":"bool"}));
var forceZUp=op.addInPort(new Port(op,"Force Z Up",CABLES.OP_PORT_TYPE_VALUE,{"display":"bool"}));

var geomOut=op.addOutPort(new Port(op,"Geometry Out",CABLES.OP_PORT_TYPE_OBJECT));
