...
var orderPort = op.addInPort( new Port( op, "Order", CABLES.OP_PORT_TYPE_, { 'display': 'range', 'min': ORDER_MIN, 'max': ORDER_MAX } ));
orderPort.set(ORDER_DEFAULT);
var oversamplePort = this.addInPort( new Port( this, "align", CABLES.OP_PORT_TYPE_, { display: 'dropdown', values: OVERSAMPLE_VALUES } ) );
