...
var execute=this.addInPort(new Port(this,"execute",CABLES.OP_PORT_TYPE_FUNCTION) );
...
var next=this.addOutPort(new Port(this,"next",CABLES.OP_PORT_TYPE_FUNCTION));
...
// diffuse texture
var diffuseTexture=this.addInPort(new Port(this,"Diffuse Texture",CABLES.OP_PORT_TYPE_TEXTURE,{preview:true,display:'createOpHelper'}));
...
// emissive texture
var emissiveTexture=this.addInPort(new Port(this,"Emissive Texture",CABLES.OP_PORT_TYPE_TEXTURE,{preview:true,display:'createOpHelper'}));
