...
var patternTypePort = op.addInPort( new Port( op, "Pattern Type", CABLES.OP_PORT_TYPE_, { display: 'dropdown', values: PATTERN_TYPES } ) );
...
var humanizePort = op.addInPort( new Port( op, "Humanize", CABLES.OP_PORT_TYPE_, { display: 'bool' } ) );
