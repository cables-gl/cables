...
var useHeight=this.addInPort(new Port(this,"useHeight",OP_PORT_TYPE_VALUE,{"display":"bool"}));
...
function createMesh(arr,start,end)
{
    ...
    for(i=start;i<end;i++)
    {
        ...
        if(useHeight.get()) verts[ind*3+2]=coord.z;
            else verts[ind*3+2]=arr[i][2];
