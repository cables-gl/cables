...
let voicePort = op.addInPort(new CABLES.Port(op, "Voice", CABLES.Port.TYPE_VALUE, { "display": "dropdown", "values": voiceMapKeys }));
let pitchPort = op.addInPort(new CABLES.Port(op, "Pitch", CABLES.Port.TYPE_VALUE, { "display": "range", "min": PITCH_MIN, "max": PITCH_MAX }));
pitchPort.set(PITCH_DEFAULT);
let ratePort = op.addInPort(new CABLES.Port(op, "Rate", CABLES.Port.TYPE_VALUE, { "display": "range", "min": RATE_MIN, "max": RATE_MAX }));
ratePort.set(RATE_DEFAULT);
let volumePort = op.addInPort(new CABLES.Port(op, "Volume", CABLES.Port.TYPE_VALUE, { "display": "range", "min": VOLUME_MIN, "max": VOLUME_MAX }));
