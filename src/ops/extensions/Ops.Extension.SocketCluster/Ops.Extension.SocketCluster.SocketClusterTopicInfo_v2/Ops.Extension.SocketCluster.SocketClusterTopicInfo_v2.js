const inSocket = op.inObject("Socket", null, "socketcluster"),
    ...
    inTimeout = op.inInt("Timeout Seconds", 20),
    inSoftTimeout = op.inInt("Soft Timeout Seconds", 15),
...
const cleanupClients = () =>
{
    ...
    const now = Date.now();
    const timeout = inTimeout.get()*1000;
    const softTimeout = inSoftTimeout.get()*1000;
