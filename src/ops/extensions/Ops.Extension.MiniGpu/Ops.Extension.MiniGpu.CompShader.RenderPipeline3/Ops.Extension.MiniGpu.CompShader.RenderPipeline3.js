const
    ...
    moduleFrag = op.inObject("Fragment", null, "shadermodule"),
    moduleVertex = op.inObject("Vertex", null, "shadermodule"),
...
exec.onTriggered = () =>
{
    ...
    if (!pipe || mgpu.rebuildPipeline)
    {
        ...
        let bindsFrag = []; // mgpu.shaderModules?.fragment?.bindings?.array();
        if (moduleFrag.get())
            bindsFrag = moduleFrag.get().bindings;
        console.log("bindsfrag", bindsFrag);
        ...
        updatedFrag = mgpu.shaderModules.fragment?.updated || 0;
        ...
        const o = {
            ...
            "fragment": moduleFrag.get().shader,
            "primitive":
            {
        ...
        console.log("o", bindGroupLayoutFrag);
    }
