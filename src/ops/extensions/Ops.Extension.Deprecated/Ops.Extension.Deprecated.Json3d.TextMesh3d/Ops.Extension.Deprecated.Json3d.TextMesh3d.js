...
let filename = this.addInPort(new CABLES.Port(this, "file", CABLES.Port.TYPE_VALUE, { "display": "file", "type": "string", "filter": "mesh" }));
let text = op.inValueString("Text", "cables");
let inSize = op.inFloat("Depth", 0.2);
let inSpace = op.inFloat("Spacing", 0.1);

let next = this.addOutPort(new CABLES.Port(this, "trigger", CABLES.Port.TYPE_FUNCTION));
