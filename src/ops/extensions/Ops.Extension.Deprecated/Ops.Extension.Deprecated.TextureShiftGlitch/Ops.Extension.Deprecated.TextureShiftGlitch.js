...
this.pos = this.addInPort(new CABLES.Port(this, "pos", CABLES.Port.TYPE_VALUE, { "display": "range" }));
this.height = this.addInPort(new CABLES.Port(this, "height", CABLES.Port.TYPE_VALUE, { "display": "range" }));
