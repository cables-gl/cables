...
let patternTypePort = op.addInPort(new CABLES.Port(op, "Pattern Type", CABLES.Port.TYPE_VALUE, { "display": "dropdown", "values": PATTERN_TYPES }));
...
let humanizePort = op.addInPort(new CABLES.Port(op, "Humanize", CABLES.Port.TYPE_VALUE, { "display": "bool" }));
