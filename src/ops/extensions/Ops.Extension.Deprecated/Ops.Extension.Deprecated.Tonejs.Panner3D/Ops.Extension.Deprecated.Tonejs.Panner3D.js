...
let panningModelPort = op.addInPort(new CABLES.Port(op, "Panning Model", CABLES.Port.TYPE_VALUE, { "display": "dropdown", "values": PANNING_MODEL_VALUES }));
...
let distanceModelPort = op.addInPort(new CABLES.Port(op, "Distance Model", CABLES.Port.TYPE_VALUE, { "display": "dropdown", "values": DISTANCE_MODEL_VALUES }));
distanceModelPort.set(DISTANCE_MODEL_DEFAULT);
let coneInnerAnglePort = op.addInPort(new CABLES.Port(op, "Cone Inner Angle", CABLES.Port.TYPE_VALUE, { "display": "range", "min": ANGLE_MIN, "max": ANGLE_MAX }));
coneInnerAnglePort.set(CONE_INNER_ANGLE_DEFAULT);
let coneOuterAnglePort = op.addInPort(new CABLES.Port(op, "Cone Outer Angle", CABLES.Port.TYPE_VALUE, { "display": "range", "min": ANGLE_MIN, "max": ANGLE_MAX }));
