...
let pitchPort = op.inFloat("Pitch", PITCH_DEFAULT);
let windowSizePort = op.addInPort(new CABLES.Port(op, "Window Size", CABLES.Port.TYPE_VALUE, { "display": "range", "min": WINDOW_SIZE_MIN, "max": WINDOW_SIZE_MAX }, node.get("windowSize").windowSize));
