...
let uniCube = new CGL.Uniform(shader, "t", "skybox", 0);
let uniRough = new CGL.Uniform(shader, "t", "maskRoughness", 1);
var uniRefl = new CGL.Uniform(shader, "t", "maskReflection", 2);
let uniNormal = new CGL.Uniform(shader, "t", "texNormal", 3);
let uniDiffuse = new CGL.Uniform(shader, "t", "texDiffuse", 4);
let uniAo = new CGL.Uniform(shader, "t", "texAo", 5);
var uniRefl = new CGL.Uniform(shader, "t", "mapReflection", 6);
let uniRotOff = new CGL.Uniform(shader, "f", "fRotation", inRotation);
let uniMulRefl = new CGL.Uniform(shader, "f", "mulReflection", inReflMul);
let uniMulRoug = new CGL.Uniform(shader, "f", "mulRoughness", inRoughMul);
