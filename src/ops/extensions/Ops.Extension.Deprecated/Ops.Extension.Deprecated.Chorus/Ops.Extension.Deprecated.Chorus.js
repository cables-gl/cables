...
// var delayTimePort = op.addInPort( new CABLES.Port( op, "Delay Time", CABLES.Port.TYPE_VALUE, { 'display': 'range', 'min': DELAY_TIME_MIN, 'max': DELAY_TIME_MAX } ));
// delayTimePort.set(DELAY_TIME_DEFAULT);
// var oscillatorTypePort = op.addInPort( new CABLES.Port( op, "Oscillator Type", CABLES.Port.TYPE_VALUE, { display: 'dropdown', values: OSCILLATOR_TYPES } ) );
// oscillatorTypePort.set(OSCILLATOR_TYPE_DEFAULT);
// var spreadPort = op.addInPort( new CABLES.Port( op, "Spread", CABLES.Port.TYPE_VALUE, { 'display': 'range', 'min': SPREAD_MIN, 'max': SPREAD_MAX } ));
