...
// var exe=this.addInPort(new CABLES.Port(this,"exe",CABLES.Port.TYPE_FUNCTION));
// const trigger=op.outTrigger("trigger");

// var attachment=this.addOutPort(new CABLES.Port(this,"attachment",CABLES.Port.TYPE_FUNCTION));

// var attenuation=this.addInPort(new CABLES.Port(this,"attenuation",CABLES.Port.TYPE_VALUE));

// var mul=this.addInPort(new CABLES.Port(this,"multiply",CABLES.Port.TYPE_VALUE,{display:'range'}));
// mul.set(1);

// var cone=this.addInPort(new CABLES.Port(this,"cone",CABLES.Port.TYPE_VALUE,{ display:'range' }));
// cone.set(0.85);
// var r=this.addInPort(new CABLES.Port(this,"r",CABLES.Port.TYPE_VALUE,{ display:'range', colorPick:'true' }));
// var g=this.addInPort(new CABLES.Port(this,"g",CABLES.Port.TYPE_VALUE,{ display:'range' }));
// var b=this.addInPort(new CABLES.Port(this,"b",CABLES.Port.TYPE_VALUE,{ display:'range' }));

// var x=this.addInPort(new CABLES.Port(this,"x",CABLES.Port.TYPE_VALUE));
// var y=this.addInPort(new CABLES.Port(this,"y",CABLES.Port.TYPE_VALUE));
// var z=this.addInPort(new CABLES.Port(this,"z",CABLES.Port.TYPE_VALUE));

// var tx=this.addInPort(new CABLES.Port(this,"target x",CABLES.Port.TYPE_VALUE));
// var ty=this.addInPort(new CABLES.Port(this,"target y",CABLES.Port.TYPE_VALUE));
// var tz=this.addInPort(new CABLES.Port(this,"target z",CABLES.Port.TYPE_VALUE));

// var tex=this.addOutPort(new CABLES.Port(this,"texture",CABLES.Port.TYPE_TEXTURE,{preview:true}));
// var texDepth=this.addOutPort(new CABLES.Port(this,"textureDepth",CABLES.Port.TYPE_TEXTURE));
