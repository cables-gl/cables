...
let sg = new CGL.ShaderGraph(this, CGL.ShaderGraph.LANG_GLSL, inFrag, inVertex);
const shader = new CGL.Shader(cgl, op.name);
let needsUpdate = true;
let uniformTextures = [];

shader.setModules(["MODULE_VERTEX_POSITION", "MODULE_COLOR", "MODULE_BEGIN_FRAG", "MODULE_BEGIN_VERTEX", "MODULE_VERTEX_MODELVIEW"]);
