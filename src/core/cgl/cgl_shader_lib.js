...
ShaderLibMods["CGL.RANDOM_OLD"] = function ()
{
...
ShaderLibMods["CGL.RANDOM_LOW"] = function ()
{
    this.name = "randomNumber";
    this.srcHeadFrag = "".endl()
        + "float cgl_random(vec2 co)".endl()
...
ShaderLibMods["CGL.RANDOM_TEX"] = function ()
{
