...
export class AmmoWorld extends Events
{
    constructor()
    {
        super();
    ...
    _getGeomTriangle = function (geom, i)
    {
    ...
    static createConvexHullFromGeom = function (geom, numTris, scale)
    {
        scale = scale || [1, 1, 1];
    ...
    static copyCglTransform = function (cgl, transform)
    {
