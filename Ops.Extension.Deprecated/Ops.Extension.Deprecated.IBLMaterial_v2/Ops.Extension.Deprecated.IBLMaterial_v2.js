...
const shader = new CGL.Shader(cgl, "ibl material 2");
...
const uniCube = new CGL.Uniform(shader, "t", "irradiance", 0);
const uniRough = new CGL.Uniform(shader, "t", "maskRoughness", 7);
var uniRefl = new CGL.Uniform(shader, "t", "maskReflection", 2);
const uniNormal = new CGL.Uniform(shader, "t", "texNormal", 3);
const uniDiffuse = new CGL.Uniform(shader, "t", "texDiffuse", 4);
const uniAo = new CGL.Uniform(shader, "t", "texAo", 5);
var uniOpacity = new CGL.Uniform(shader, "t", "texOpacity", 6);
var uniRefl = new CGL.Uniform(shader, "t", "mapReflection", 1);
const uniRotOff = new CGL.Uniform(shader, "f", "fRotation", inRotation);
const uniMulRefl = new CGL.Uniform(shader, "f", "mulReflection", inReflMul);
const uniMulRoug = new CGL.Uniform(shader, "f", "mulRoughness", inRoughMul);
const uniAoAmount = new CGL.Uniform(shader, "f", "aoIntensity", inAoIntensity);
const uniNormalIntensity = new CGL.Uniform(shader, "f", "normalIntensity", inNormalIntensity);
const uniRepeatX = new CGL.Uniform(shader, "f", "repeatX", inRepeatX);
const uniRepeatY = new CGL.Uniform(shader, "f", "repeatY", inRepeatY);
